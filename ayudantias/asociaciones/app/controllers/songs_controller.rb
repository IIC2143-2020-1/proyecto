class SongsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @song.update(song_params)
        format.html { redirect_to album_path(@song.album), notice: 'Song was successfully updated.' }
  ...
  def destroy
    @song.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Song was successfully destroyed.' }
